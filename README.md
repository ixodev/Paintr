...
Paintr is an AI that generates images based on a given prompt. It is written in JavaScript and a bit of python. This project is a collaboration between Younes Bendimerad and TotoroGaming (aka Kubik).
...
Paintr is Copyright (c) Younes Bendimerad (formerly known as GreyWolf-dev) and TotoroGaming.
